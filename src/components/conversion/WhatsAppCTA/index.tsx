...
const sizeClasses = {
  sm: 'text-[0.6875rem] px-5 py-2.5 gap-1.5',
  md: 'text-[0.6875rem] px-7 py-3.5 gap-2',
  lg: 'text-[0.75rem] px-9 py-4 gap-2.5',
};

export function WhatsAppCTA({
  message = "Hi! I'd like to enquire about a shoot at The Picture Villa.",
  label = 'WhatsApp Us',
  className,
  variant = 'button',
  size = 'md',
}: WhatsAppCTAProps) {
  const href = `https://wa.me/919811242594?text=${encodeURIComponent(message)}`;
